    ...
    <div className="min-h-screen bg-black text-white relative overflow-hidden">
      ...
      <div className="flex flex-col items-center justify-center min-h-screen px-6 pt-28">
        ...
        <p className="text-gray-400 text-xl text-center mt-8 max-w-3xl leading-relaxed">
          Master technical interviews, analyze resumes, track progress,
          and boost your placement success using cutting-edge AI tools
          designed for students and job seekers.
        </p>

        <button
          onClick={() => navigate("/login")}
          className="mt-12 bg-gradient-to-r from-purple-500 to-blue-500 px-10 py-4 rounded-full font-semibold text-lg hover:scale-105 transition duration-300 shadow-lg shadow-purple-500/30"
        >
          Start Your Journey
        </button>
